...
// Define a class to represent a persistent websocket connection
...
class PersistentSocket {
  ...
  createNewWebSocket() {
    ...
    this.ws.onopen = function(event) { console.log("Socket opened."); };

    // Listen for messages
    this.ws.onmessage = function(event) { console.log("Message received"); };
    this.ws.onclose = function(event) {
      console.log("Socket closed");
      setTimeout(this.createNewWebSocket(), 1);
    };
  }
}

// Create WebSocket connection
const socket = new PersistentSocket("localhost", 9000)
