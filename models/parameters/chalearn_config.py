...
EXPERIMENT_DESCRIPTION = "Chalearn-high-low_25perc-cutoff_15secMax_noClassWeights_IS1010_"
...
chalearn_predtype = "high-low"  # high-low # high-med-low # max_class
...
model_params = Namespace(
    ...
    final_output_dim=2,  # output vec for each task
    # FC layer parameters
    num_fc_layers=1,  # 1,  # 2,
