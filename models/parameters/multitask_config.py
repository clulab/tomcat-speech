...
EXPERIMENT_DESCRIPTION = "MUStARD_25perc-cutoff_15secMax_AudioOnly_IS1076_"
...
exp_save_path = "output/multitask/mustard-chalearn-experiments"
...
model_params = Namespace(
    ...
    output_2_dim=7,  # 3,    # output vec for third task
    output_3_dim=0,
    # FC layer parameters
    num_fc_layers=1,  # 1,  # 2,
