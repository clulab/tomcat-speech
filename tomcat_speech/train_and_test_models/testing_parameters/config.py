...
EXPERIMENT_DESCRIPTION = "MC_GOLD_classwts_nogender_25to75perc_avg_IS13_"
...
# glove_file = "/data/nlp/corpora/MM/glove.short.300d.punct.txt"
# glove_file = "../../glove.42B.300d.txt"

pickle_dir = "IS13_GOLD"
...
exp_save_path = "output/forasisttest"
...
model_params = Namespace(
    ...
    seed=88,  # 1007
    # trying text only model or nota
    text_only=False,
    audio_only=False,
